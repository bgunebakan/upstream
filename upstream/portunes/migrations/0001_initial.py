# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-13 18:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='action',
            name='action_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portunes.Action_type', verbose_name=b'Hareket'),
        ),
        migrations.AddField(
            model_name='action',
            name='door',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='portunes.Door', verbose_name=b'Kap\xc4\xb1'),
        ),
        migrations.AddField(
            model_name='action',
            name='identifier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portunes.Identifier', verbose_name=b'Kart No'),
        ),
        migrations.AddField(
            model_name='action',
            name='user',
