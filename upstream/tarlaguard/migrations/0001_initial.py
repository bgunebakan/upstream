    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name=b'Tarih-Saat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True, verbose_name=b'G\xc3\xbcncelleme tarihi')),
                ('deleted', models.BooleanField(default=False, verbose_name=b'Silinmi\xc5\x9f')),
                ('entrance', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='entrance_controller', to='tarlaguard.Controller', verbose_name=b'Kontrolc\xc3\xbc')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('door', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tarlaguard.Door')),
        ...
        migrations.AddField(
            model_name='action',
            name='action_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tarlaguard.Action_type', verbose_name=b'Hareket'),
        ),
        migrations.AddField(
            model_name='action',
            name='door',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tarlaguard.Door', verbose_name=b'Kap\xc4\xb1'),
        ),
        migrations.AddField(
            model_name='action',
            name='identifier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tarlaguard.Identifier', verbose_name=b'Kart No'),
        ),
        migrations.AddField(
            model_name='action',
            name='personnel',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='personnel.Personnel', verbose_name=b'Personel'),
        ),
    ]
