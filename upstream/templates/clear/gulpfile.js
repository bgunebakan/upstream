...
var paths = {
    ...
    'bootstrap': node_vendors + 'bootstrap/dist/',
...
elixir(function (mix) {
    ...
    mix.sass('custom_dark.scss', 'css/custom.css');
    ...
    mix.styles(
        [
            ...
            '../../vendors/themify/css/themify-icons.css',
            '../../css/custom_css/metisMenu.css',
            '../../vendors/bootstrap-switch/css/bootstrap-switch.min.css'
        ], destCss + 'app.css');
    ...
    mix.scripts(
        [
            ...
            '../../js/bootstrap.min.js',
            '../../js/custom_js/leftmenu.js',
            '../../vendors/jquerynicescroll/jquery.nicescroll.min.js',
            '../../js/custom_js/rightside_bar.js',
